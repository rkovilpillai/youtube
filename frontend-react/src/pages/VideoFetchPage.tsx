    ...
    <div className="page">
      ...
      <div className="grid-two">
        <SectionCard
          ...
          description="Tune YouTube parameters and launch a fetch job."
        >
          <form
            className="form-grid"
            onSubmit={(e) => {
        ...
        {fetchMutation.data && fetchMutation.data.success && (
          ...
          >
            <div className="metrics-grid">
              ...
              <div>
                <h4>Quota Used</h4>
                <p>{fetchMutation.data.data.quota_used}</p>
              </div>
            </div>
          </SectionCard>
        )}
      ...
      <SectionCard
        ...
        description="Inspect campaign inventory and open videos on YouTube."
      >
